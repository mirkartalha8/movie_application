...
const uri ="mongodb+srv://Admin:Qwerty12345@cluster0.prmpnbi.mongodb.net/?appName=Cluster0/Movie"; //MongoDB Atlas Link 
...
database.collection("MovieCollection"); // Adjust the collection name 
 ...
 console.log("Entered into user login error."); 
    ...
    app.get("/delete-movie-form.html", (req, res) => { 
      res.sendFile(__dirname + "/Templates/delete-movieform.html"); 
    }); 
 
    // Serve update-seats-form.html 
    app.get("/update-seats-form.html", (req, res) => { 
      res.sendFile(__dirname + "/Templates/update-seatsform.html"); 
    }); 
